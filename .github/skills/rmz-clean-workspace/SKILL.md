...
7. When opening or updating a pull request for this work, write its title and summary as Markdown with real line breaks. Use a quoted heredoc or body file rather than escaped `\n` sequences, then inspect the rendered body with `gh pr view` to confirm the formatting.
